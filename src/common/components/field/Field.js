  ...
  return (
    <div className="w-full">
      ...
      <div className="flex">
        ...
        {rightAddOn && (
          <button
            className="z-10 inline-flex flex-shrink-0 items-center rounded-e-md border border-l-0 border-gray-300 bg-[#f3f7fe] px-2.5 py-1.5 text-center text-sm font-medium text-gray-400"
            type="button">
            {rightAddOn}
          </button>
        )}
