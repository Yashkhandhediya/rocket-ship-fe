            ...
            <BillingTabs>
                ...
                <div className="flex flex-row w-full justify-evenly my-4 px-6">
                    {charges.map((charge, index) => (
                        <div key={index} className="flex flex-col gap-1 font-semibold bg-[#159700] text-white justify-between text-center w-[17rem] py-2">
                ...
                <div className='overflow-x-scroll ml-4 text-[12px] font-bold text-[#333333]'>
                    <div className='flex flex-row border-t-2 w-[113%] border-b-2'>
                        ...
                        <div className='pl-2 border-r-2 w-36 py-2 pr-2 flex flex-row justify-between'>
                            <span>Courier</span>
                            <svg className="w-4 h-4 text-transparent dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="#159700" viewBox="0 0 24 24">
                        ...
                        <div className='pl-2 border-r-2 w-44 py-2 pr-2 flex flex-col'>
                            <div className='flex flex-row justify-between'>
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" fill='none' viewBox="0 0 24 24" strokeWidth={1.5} stroke="#159700" className="w-4 h-4">
