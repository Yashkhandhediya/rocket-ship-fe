    ...
    return (
        <div>
            <div className="flex flex-row w-full justify-start my-4 px-6">
                <button className={`text-[13px] border border-r-0 px-4 py-1 rounded-l-[3px] focus:outline-none ${0 === activeTab ? 'font-semibold border-[#1D99D9] bg-[#285FDB] text-white' : 'font-normal border-[#CFD4D6] text-[#333333] bg-[#FAFAFA]'}`}
                    onClick={() => setActiveTab(0)}
                >
                    {'COD Reconciliation'}
                </button>
                <button className={`text-[13px] border border-l-0 px-4 py-1 rounded-r-[3px] focus:outline-none ${1 === activeTab ? 'font-semibold border-[#1D99D9] bg-[#285FDB] text-white' : 'font-normal border-[#CFD4D6] text-[#333333] bg-[#FAFAFA]'}`}
                ...
                {activeTab === 0 &&
                    <div className="ml-2 flex flex-row gap-2">
                        ...
                        <div>
                            <div className="group relative">
                                <input
                                    type={'date'}
                                    id="default-search"
                                    className={`block w-[150px] rounded-[4px] border-opacity-90 border border-gray-300 bg-gray-50 px-5 py-1 text-[12px] text-[#757575] focus:border-blue-500 focus:ring-blue-500`}
                                    required
                                    onChange={(ev) => {
                        ...
                        <div>
                            ...
                            <button
                                className={`border-1 h-[33px] w-[100px] rounded-[4px] border-[#285FDB] bg-[#285FDB] text-[12px] leading-[30px] text-white hover:text-white}'}}`}
                                onClick={() => {
                                    handleDateChange();
                                }}>
                                Apply
