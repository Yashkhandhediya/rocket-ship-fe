  ...
  return (
    <div className="my-4 rounded-lg bg-red-50 p-4">
      <p className="text-[12px] font-semibold">
        ...
        <span className="text-[10px] text-gray-500">(Only csv file format will be accepted.)</span>
      </p>
