...
const Order_tag = ({show,onClose}) => {
  ...
  return (
    ...
    <div className="flex flex-row justify-between items-center mb-2">
      <label className="block text-gray-500 font-semibold mb-2">Order Tags</label>
        ...
        <div className="absolute inset-x-0 top-full -mt-3 ml-3 w-64 bg-white border-gray-300 rounded-md shadow-lg">
          ...
          <div>
            {categories.length > 0 ? (
              ...
              <div className="px-2 py-2 text-gray-500">No Order Tag Found</div>
            )}
          </div>
        </div>
      )}
