  ...
  return (
    <PageWithSidebar>
      ...
      <div className="flex flex-col items-center justify-center gap-4 p-3">
        ...
        <div className="mb-3 ml-60 w-[40%] md:flex">
          <div className="mr-6 text-lg font-medium">{'Type Of Shipment :'}</div>
          <div className="lg:w-2/12">
            ...
            />
            <label htmlFor="ftl" className="mb-2 inline-flex items-center text-xs font-medium text-gray-900">
              FTL
            </label>
          </div>
          <div className="lg:w-2/12">
            <input
              ...
              onChange={handleShipment}
            />
            <label htmlFor="ptl" className="mb-2 inline-flex items-center text-xs font-medium text-gray-900">
              PTL
            </label>
          </div>
        </div>
