...
import ShipmentCourierPartnersTable from './ShipmentCourierPartnersTable';
import ShipmentSelfFullfiled from './ShipmentSelfFullfiled';
...
//   const [isLoading, setIsLoading] = useState(true)
  console.log("Detailssssssssss",orderDetails)
  const tabsData = [
    {
      title: 'All',
      id: 'all',
...
//   }, [orderDetails?.id, isOpen]);
  ...
  useEffect(() => {
   setShipmentDetails(orderDetails)
  }, [orderDetails]);
