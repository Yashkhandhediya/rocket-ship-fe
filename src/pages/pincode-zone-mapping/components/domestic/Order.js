    ...
    <>
      ...
      <input type="text" id="shipment-value" className="form-input w-full rounded-md border-gray-300 focus:ring-purple-500 focus:border-purple-500" placeholder="Enter the shipment value" /> */}
        ...
        <div className="mt-8 w-1/2">
          <p className="mb-2 border-b pb-2 text-xl font-semibold text-red-800">
            Pickup-Zone Serviceability Sheet
          </p>
          <Field
            type={'number'}
            id={`pickup_pincode`}
        ...
        <button className="mr-2 mt-2 rounded-md bg-red-800 px-4 py-2 text-sm font-semibold text-white">
          Export
        </button>
      </div>
    </>
