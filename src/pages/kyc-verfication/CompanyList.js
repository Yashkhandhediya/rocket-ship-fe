...
const CompanyList = () => {
  ...
  const handleCompany = () => {
    apiClient
      .get(BACKEND_URL + '/company/get_all_companies/')
      .then((res) => {
  ...
  const handleCompanyKYC = (row) => {
    ...
    setIdUser(row?.id);
    apiClient
      .get(BACKEND_URL + `/kyc/?id=${row?.id}&type=company_pan`, { responseType: 'blob' })
      .then((res) => {
    ...
    apiClient
      .get(BACKEND_URL + `/kyc/?id=${row?.id}&type=company_logo`, { responseType: 'blob' })
      .then((res) => {
        console.log('Recharge Responsee', res);
        const imgUrl = URL.createObjectURL(res.data);
    ...
    apiClient
      .get(BACKEND_URL + `/kyc/?id=${row?.id}&type=company_gst`, { responseType: 'blob' })
      .then((res) => {
        console.log('Recharge Responsee', res);
        const imgUrl = URL.createObjectURL(res.data);
    ...
    apiClient
      .get(BACKEND_URL + `/kyc/?id=${row?.id}&type=company_stamp`, { responseType: 'blob' })
      .then((res) => {
        console.log('Recharge Responsee', res);
        const imgUrl = URL.createObjectURL(res.data);
