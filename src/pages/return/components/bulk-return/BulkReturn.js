  ...
  return (
    <div>
      <div className="px-4 lg:pl-[100px] lg:pr-[120px]">
        <div className="mb-5 mt-8 text-xl font-bold"> {'Bulk Orders'} </div>
        <div className="mb-6 w-full  rounded-xl bg-white p-5">
          <div className="flex w-full flex-wrap gap-2 md:gap-0">
            <div className="px-2 text-base font-medium md:w-6/12">{'Import Bulk Orders'}</div>
            <div className="flex justify-end px-2 md:w-6/12">
              <button className="flex w-[180px] items-center justify-between rounded-[4px] border border-[#d3d3d3] bg-[#efedff] pb-2 pl-4 pr-4 pt-2.5 text-xs text-indigo-600">
          ...
          <div className="mt-7">
            <Label htmlFor="bulkOrderDropZone">
              <div className="grid h-[190px] place-items-center rounded-[10px] border border-dashed border-indigo-700 bg-[#f4f8ff99]">
                <div className="flex flex-col items-center gap-1.5">
                  ...
                  <Label
                    ...
                    className="cursor-pointer rounded-md bg-indigo-500 px-5 py-2 text-[10px] font-medium text-white">
                    {'Browse and Upload'}
                  </Label>
        ...
        <div className="w-full overflow-auto rounded-xl bg-white p-5">
          <Table className="mb-3 w-full overflow-auto whitespace-nowrap">
            <Table.Head>
              <Table.HeadCell className="border-b border-solid border-gray-100 bg-white">
                File Name
              </Table.HeadCell>
              <Table.HeadCell className="border-b border-solid border-gray-100 bg-white">Date</Table.HeadCell>
              <Table.HeadCell className="border-b border-solid border-gray-100 bg-white">
                No. Of Returns
              </Table.HeadCell>
              <Table.HeadCell className="border-b border-solid border-gray-100 bg-white">
            ...
            <Table.Body>
              <Table.Row>
                <Table.Cell>Bulk_return_order_sample.csv</Table.Cell>
                <Table.Cell>31/10/2023</Table.Cell>
