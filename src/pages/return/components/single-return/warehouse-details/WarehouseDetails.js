...
const WarehouseDetails = ({ currentStep, handleChangeStep }) => {
  ...
  const domesticOrderPickupAddress =
    useSelector((state) => {
      console.log(state);
      return state?.addReturn?.single_return?.pickup_address;
    }) || {};
      ...
      <div className="mb-3.5 rounded-xl bg-white p-9">
        ...
        <div className="xxl:-6/12 w-full md:w-8/12 ">
          <Field
            ...
            value={searchAddress}
            inputClassNames={
              'h-4 focus:ring-orange-500 block w-full sm:text-sm border-gray-300 rounded-md bg-gray-200 text-black'
            }
