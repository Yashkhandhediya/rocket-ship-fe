...
const OTP_Input = ({ handleSendOTP, timer }) => {
    ...
    return (
        <div className="flex flex-col gap-4 mt-4">
            ...
            <div className="flex justify-start mt-2 gap-4 items-center text-[12px] font-medium">
                <button className={`px-12 py-2 text-white ${isOtpEntered ? "bg-purple-600" : "bg-[#FAFAFA] border text-[#cbcbcb] border-[#e5e5e5]"} transition-colors duration-200 rounded-md`} disabled={!isOtpEntered}>
                    Complete KYC
                </button>
                {seconds > 0 ?
