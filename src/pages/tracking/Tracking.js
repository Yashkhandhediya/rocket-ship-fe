            ...
            <div className="delivery-partner">
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                ...
                <div className="font-0.8">
                  <div>Tracking ID</div>
                  <div style={{ color: 'red' }}>
                    {shipmentData && shipmentData.waybilll_no ? shipmentData.waybilll_no : 'N.A.'}
                  </div>
                </div>
              </div>
              <div>
          ...
          <div className="order-details-container">
            ...
            <div>
              ...
              <div className="order-grid-container font-0.8">
                ...
                <div className="order-grid-item">
                  <span>
                    {shipmentData && shipmentData.order_date ? shipmentData.order_date.split('T')[0] : 'N.A.'}
                  </span>
                </div>
              </div>
            </div>
            ...
            <form style={{ boxSizing: 'border-box' }}>
              ...
              <button
                style={{
                  ...
                  overflow: 'visible',
                  margin: '0px',
                  background: 'rgb(41, 96, 219) none repeat scroll 0% 0% / auto padding-box border-box',
                }}>
                Submit
              </button>
            </form>
