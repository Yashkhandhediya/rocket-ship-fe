    ...
    useEffect(() => {
        const fetchPlanType = async () => {
            try {
                ...
                setTermsAccepted({ [result.plan_type]: true });
            } catch (error) {
        ...
        <PageWithSidebar>
            ...
            <div className="bg-[#EDEDED] w-full px-6 pb-16 mx-2">
                ...
                <div className="bg-white flex flex-col gap-3 p-4">
                    <div className="relative bg-white ml-7 mt-7">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            {plans.map((plan) => (
                                <div key={plan.planType} className="relative bg-white p-4 rounded-lg shadow-lg border">
                                    {label === plan.planType && (
                                        <div className="w-[60%] top-0 left-0 absolute bg-red-500 text-black px-2 py-1 text-center rounded-tl-lg rounded-br-lg z-5" style={{ minWidth: '10px' }}>
                                    ...
                                    {2 === plan.planType && (
                                        <div className="w-[60%] top-0 left-0 absolute bg-yellow-400 text-black px-2 py-1 text-center rounded-tl-lg rounded-br-lg z-5" style={{ minWidth: '10px' }}>
                                            <span className="flex items-center justify-center text-white text-sm font-semibold">
                                    ...
                                    <div className="flex flex-col items-center justify-between h-full">
                                        ...
                                        <div className="mt-4 flex items-center w-full">
                                            <input type="checkbox" id={`terms-${plan.planType}`} className="mr-2" checked={termsAccepted[plan.planType] || false} onChange={(e) => handleCheckboxChange(e, plan.planType)} />
                                        ...
                                        <button
                                            ...
                                            disabled={!termsAccepted[plan.planType]}
                                        >
                    ...
                    <div className="bg-white p-4 ml-7 mt-7">
