  ...
  return (
    <div className="relative">
      ...
      <div className="absolute z-50 mt-2 w-full rounded-lg bg-white">
        ...
        {data.selectName !== 'Sort by:Low to High Weight' && (
          <div className="flex justify-end gap-2 border-t px-2 py-2 text-[14px]">
            <button className="rounded-lg bg-blue-100 px-2 py-1 shadow">clear</button>
            <button className="rounded-lg bg-blue-100 px-2 py-1 shadow">Apply</button>
          </div>
        )}
      </div>
    </div>
