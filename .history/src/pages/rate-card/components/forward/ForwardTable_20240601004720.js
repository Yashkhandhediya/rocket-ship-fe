...
import { faBus, faBusSimple } from '@fortawesome/free-solid-svg-icons';

function ForwardTable() {
  return (
    <>
      <table className="mt-10 min-w-full overflow-hidden rounded-lg text-center text-[12px] shadow">
